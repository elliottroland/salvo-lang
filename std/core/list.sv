...
// [type-canbe-mut]: backends may map `Mut List<T>` to a different native
...
external fn list<T canbe Linear>(...elems: T[]) [] -> [] List<T>

// Mutable constructor
external fn mutable_list<T canbe Linear>(...elems: T[]) [] -> [] Mut List<T>
...
external fn add<T canbe Linear>(list: Mut List<T>, elem: T) [] -> [list: Mut] None

external fn first<T>(list: List<T>) [] -> [list] ReadOnly[from: list] T?

// Returns the number of elements in the list
external fn size<T canbe Linear>(list: List<T>) [] -> [list] Int
