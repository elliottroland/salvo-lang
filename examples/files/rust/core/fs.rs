...
pub fn close<__Fx: __Has_Fs>(__fx: &mut __Fx, p: Lines) -> Union2<(), Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    return __Has_Fs::__get_Fs(&mut *__fx).close(p.s);
}

pub fn open_lines<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String) -> Union2<Lines, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
...
pub fn close__2<__Fx: __Has_Fs>(__fx: &mut __Fx, p: Chunks) -> Union2<(), Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    return __Has_Fs::__get_Fs(&mut *__fx).close(p.s);
}

pub fn open_chunks<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String, size: i32) -> Union2<Chunks, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    let mut opened = __Has_Fs::__get_Fs(&mut *__fx).open_read(path);
    if matches!(opened, Union2::U2(_)) {
...
pub fn read_to_str<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String) -> Union2<String, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    let mut opened = __Has_Fs::__get_Fs(&mut *__fx).open_read(path);
    if matches!(opened, Union2::U2(_)) {
...
pub fn read_lines<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String) -> Union2<Vec<String>, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    let mut opened = __Has_Fs::__get_Fs(&mut *__fx).open_read(path);
    if matches!(opened, Union2::U2(_)) {
...
pub fn write_str<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String, content: &String) -> Union2<i64, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
...
pub fn read_to_bytes<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String) -> Union2<Vec<u8>, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    let mut opened = __Has_Fs::__get_Fs(&mut *__fx).open_read(path);
    if matches!(opened, Union2::U2(_)) {
...
pub fn write_bytes_to<__Fx: __Has_Fs>(__fx: &mut __Fx, path: &String, data: &Vec<u8>) -> Union2<i64, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    let mut opened = __Has_Fs::__get_Fs(&mut *__fx).open_write(path);
    if matches!(opened, Union2::U2(_)) {
        return Union2::<i64, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>>::U2(opened.u2().clone());
    }
...
pub fn fill_from<__Fx: __Has_Fs>(__fx: &mut __Fx, s: &InStream, buf: &mut Vec<u8>) -> Union2<i64, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
...
pub fn copy_stream<__Fx: __Has_Fs>(__fx: &mut __Fx, s: &InStream, w: &OutStream) -> Union2<i64, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
    let mut buf = Vec::<u8>::new();
    let mut total: i64 = 0i64;
...
pub fn copy_file<__Fx: __Has_Fs>(__fx: &mut __Fx, from: &String, to: &String) -> Union2<i64, Checked<Union8<NotFound, PermissionDenied, AlreadyExists, NotADirectory, PathEscapes, InvalidUtf8, StaleHandle, IoError>>> {
